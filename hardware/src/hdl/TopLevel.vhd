...
-- TEMPORARYMEMORY
type instr_mem is array (0 to 19) of std_logic_vector(kWamInstructionWidth - 1 downto 0);
...
-- STACK AND HEAP MEMORY BEGIN
  ...
  mem_port1_addr_cntr <= mem_addr1 when control_unit_mode = proc_exec_t
                      else control_unit_mem_addr;
  mem_port2_addr_cntr <= mem_addr2 when control_unit_mode = proc_exec_t
                      else deref2_mem_addr2;
